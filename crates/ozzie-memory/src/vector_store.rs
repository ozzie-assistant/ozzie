...
pub struct SqliteVectorStore {
    ...
    /// Embedding dimensionality — stored for future validation.
    #[allow(dead_code)]
    dims: usize,
}
...
impl SqliteVectorStore {
    ...
    pub fn new(conn: Connection, embedder: Box<dyn Embedder>, dims: usize) -> Result<Self, MemoryError> {
        conn.execute_batch(
...
impl VectorStorer for SqliteVectorStore {
    async fn upsert(&self, id: &str, content: &str, _meta: &std::collections::HashMap<String, String>) -> Result<(), MemoryError> {
